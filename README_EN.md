...
> 💡 **Gene 6.2.2** — Business/framework cache partition isolation, connection pool and route-precompile reliability fixes, expanded Monitor metrics, plus PHP 8.4+ and Redis Lua edge compatibility.
