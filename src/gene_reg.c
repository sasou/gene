...
/* {{{ ARG_INFO
 */
ZEND_BEGIN_ARG_INFO_EX(gene_reg_get_arginfo, 0, 0, 1) ZEND_ARG_INFO(0, name)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(gene_reg_has_arginfo, 0, 0, 1) ZEND_ARG_INFO(0, name)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(gene_reg_del_arginfo, 0, 0, 1) ZEND_ARG_INFO(0, name)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(gene_reg_set_arginfo, 0, 0, 2) ZEND_ARG_INFO(0, name)
...
GENE_MINIT_FUNCTION(reg) {
	...
	zend_declare_property_null(gene_reg_ce, GENE_REG_PROPERTY_REG,
			strlen(GENE_REG_PROPERTY_REG), ZEND_ACC_PROTECTED);
	//
	return SUCCESS;
}
/* }}} */
