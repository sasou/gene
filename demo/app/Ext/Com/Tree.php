...
class Tree
{
    ...
    public static function draw_tree($arr, $tree, $level, &$temp_arr, $out, $index, $id, $pid, $name)
    {
        $level ++;
        $prefix = str_pad('└─', $level + 4, '─', STR_PAD_RIGHT);
...
//        $n = str_replace("-", "&nbsp;", $n);
    ...
    public static function get_tree($array, &$temp_arr, $out = 'option', $index = null, $id = 'indus_id', $pid = 'indus_pid', $name = 'indus_name')
    {
        $tree = array();
