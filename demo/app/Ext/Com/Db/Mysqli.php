 ...
 * Mysqli Operation
 */
class Mysqli extends baseAbstract
{
    ...
    public function connect()
    {
        ...
        if (!extension_loaded('mysqli')) {
            throw new Cola_Com_Db_\Exception('NO_MYSQLI_EXTENSION_FOUND');
        }

        if ($this->config['persistent']) {
            throw new Cola_Com_Db_\Exception('MYSQLI_EXTENSTION_DOES_NOT_SUPPORT_PERSISTENT_CONNECTION');
        }
